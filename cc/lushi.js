...
// console.log(Next)
// var Espocon=document.getElementsByClassName('espocon')
// console.log(Espocon)
// var ESPimgs=espocon[0].getElementsByTagName("img");
// console.log(ESPimgs)
// var i=0;

// Next.onclik=function(){
//    for (var j = 0; j < ESPimgs.length; j++) {
//     ESPimgs[j].style.opacity="0";
       
//    }
//    ESPimgs[j].style.opacity="1";
// }